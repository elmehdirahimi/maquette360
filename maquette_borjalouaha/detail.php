...
<body class="fr">
	...
	<div class="conteneur">
		...
		<main id="main" class="contenu clearfix" role="main">
			<section role="region" class="strate-edifice2">
				<div class="strate-edifice_inner">
					...
					<div class="layout" style="margin-top: 100px;">
						<div class="strate-edifice2_boite">
							<a href="etage.php?etage=<?php echo $etage; ?>" class="btn-retour">
							...
							<div class="detail">
								<div class="detail_col1">
									<img src="img/plans_lots/<?php echo $plan_2d_image; ?>" alt="">
								</div>
							...
							<div class="strate-edifice2_ctnBoutons">
								...
								<a href="pdf/<?php echo $plan_2d_pdf; ?>" target="_blank" class="bouton2">Le plan</a>
							</div>
		...
		<div class="layout piedPage_inner">
			<div class="piedPage_ctn">
				<small class="copyrights">
					<span class="noWrap">&copy; 2019 AL OMRANE CASABLANCA SETTAT. &nbsp;Tous droits réservés. &nbsp;<a href="https://studio3d.ma" target="_blank">studio3d.ma</a></span>
				</small>
